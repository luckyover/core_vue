...
class GetInitDataAction
{
    ...
    public function handle(): InitData
    {
        ...
        $response->setLib($libs[NameDiv::CATEGORY_DIV], 1);
        $response->setLib($libs[NameDiv::MATERIAL_DIV], 2);
        $response->setLib($libs[NameDiv::PROCESSING_LOCATION_DIV], 3);
        $response->setLib($libs[NameDiv::NUMBER_OF_COLOR_DIV], 4);
