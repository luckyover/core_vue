IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SPC_M005_ACT2]') AND type in (N'P', N'PC'))
DROP PROCEDURE SPC_M005_ACT2
GO
SET ANSI_NULLS ON
GO
...
GO
-- +--TEST--+
-- EXEC SPC_M005_ACT2 '00030','902','M005','172.18.0.1';
--****************************************************************************************
--*   											
--*  処理概要/process overview	:	Delete a delivery
--*  
...
--*　更新内容/update content		:   
--****************************************************************************************
CREATE PROCEDURE SPC_M005_ACT2
	@P_delivery_cd					INT				= 0
