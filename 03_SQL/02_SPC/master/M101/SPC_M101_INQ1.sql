IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SPC_M101_INQ1]') AND type in (N'P', N'PC'))
DROP PROCEDURE SPC_M101_INQ1
GO
SET ANSI_NULLS ON
GO
...
GO
-- +--TEST--+
-- EXEC SPC_M101_INQ1 'ITEM1','','809','M101','172.19.0.1';
--****************************************************************************************
--*   											
...
--*　更新内容/update content		:   
--****************************************************************************************
CREATE PROCEDURE SPC_M101_INQ1
